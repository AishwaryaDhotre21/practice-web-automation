...
public class DemoClassToTestSoftAssert extends Initialization
{
    UtilityMethods obj=new UtilityMethods();

    AccessReviewPage objAccessReviewPage=new AccessReviewPage();

    @Test(priority = 1,testName = "Check the soft assert", description = "desc-test soft assert object")
    public void demo_call_1() throws InterruptedException {
        reporter=getReporter();
       obj.clickAccessReviewLink();
       objAccessReviewPage.checkSoftAssert_1();
    }
